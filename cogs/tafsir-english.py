...
invalid_verse = '**Invalid verse.** Please type the command in this format: `{0}tafsir surah:ayah tafsirname`.' \
                '\n\ne.g. `{0}tafsir 1:1 ibnkathir`'

invalid_tafsir = "**Couldn't find tafsir!** choose one from the list: `{0}tafsirlist`"
