...
from cogs.utils import get_site_source, convert_to_arabic_number, convert_from_arabic_number
...
class Tafsir(commands.Cog):
    ...
    async def tafsirlist(self,ctx: discord.Interaction):
        ...
        embed.add_field(name='Arabic', inline=False, value='```ibnkathir, tabari, jalalayn, ibnalqayyim'
